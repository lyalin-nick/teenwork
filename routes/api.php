...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('/employer')->middleware('employer')->group(function () {
        ...
        Route::prefix('/task')->group(function () {
            ...
            Route::get('/{taskId}/performers-map', [EmployerTaskController::class, 'performersOnMap']);
            Route::post('/{taskId}/finish', [EmployerTaskController::class, 'finish']);
            Route::get('/{taskId}/performers-without-review', [EmployerTaskController::class, 'performersWithoutReview']);
        });
