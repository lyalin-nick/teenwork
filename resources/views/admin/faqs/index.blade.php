    ...
    @php
        ...
        foreach ($faqs as $faq) {
            $data[] = [
                $faq->question,
                '<nobr>
                    <a href="'.route('admin.faqs.edit', ['faq' => $faq->id]).'" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
                        <i class="fa fa-lg fa-fw fa-pen"></i>
                    </a>
                    <x-adminlte-button data-href="'.route('admin.faqs.destroy', ['faq' => $faq->id]).'" label="Delete" data-toggle="modal" data-target="#modalDelete" class="btn btn-xs btn-default text-danger mx-1 shadow js-delete">
